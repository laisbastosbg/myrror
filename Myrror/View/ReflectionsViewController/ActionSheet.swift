...
extension ViewController {
    func presentMenuSheet(indexPath : IndexPath) {
        ...
        let cancelActionButton = UIAlertAction(title: "Cancelar", style: .cancel)
        let delectActionButton = UIAlertAction(title: "Excluir", style: .destructive){_ in
        ...
        let editActionButton = UIAlertAction(title: "Editar", style: .default){ _ in
